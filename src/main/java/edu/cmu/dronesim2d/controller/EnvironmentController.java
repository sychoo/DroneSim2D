...
import edu.cmu.dronesim2d.model.entity.*;
import edu.cmu.dronesim2d.model.Environment;
import edu.cmu.dronesim2d.model.entity.boat.Boat;
import edu.cmu.dronesim2d.model.entity.drone.Drone;

import edu.cmu.dronesim2d.util.exceptions.ClickOutsideRegionException;
import edu.cmu.dronesim2d.util.UniqueIDGenenator;
